...
<head>
	...
	<title>Insert Notice : find Direct your job</title>
                ...
                <form action="ninsert.do" method="post">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="notice_title" style="width:100%; height:25px;"></td>
                        </tr>
                        <tr>
                            <td style="margin-top: 15px;">내용 : </td>
                            <td><textarea id="editor" name="notice_content"></textarea></td>
                        </tr>
                        <tr>
                        	<td colspan="2"><p align="center">
                        	<button class="btn btn-success btn-sm" id="ninsert" type="submit">글 등록하기</button>
                        	&nbsp;&nbsp;&nbsp;
                        	<button class="btn btn-warning btn-sm" id="cancel" type="reset">작성 취소</button>
                        	</p></td>
                        </tr>
                        <tr>
                        	<td colspan="2"></td>
