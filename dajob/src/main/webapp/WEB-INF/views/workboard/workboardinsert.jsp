	...
	<div>
		<div class="panel panel-default">
			<div class="panel-body article">
				<form method="post" action="workboardInsert.do">
					<h4>채용공고 등록하기</h4>
					<div class="panel panel-default">
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-md-2 mb-2">
									<label>회사 아이디</label>
									<input type="text" name="writer" class="form-control is-valid" id="validationServer02" placeholder="Last name" value="${company.member_id}" readonly>
								</div>
								<div class="col-md-2 mb-2">
									<label>회사 창립일</label>
									<input type="date" name="date" class="form-control is-valid" id="validationServer02" placeholder="Last name" value="${company.company_date}" readonly> 
								</div>
								...
								<div class="col-md-4 mb-4">
									<label>회사 위치</label>
									<input type="text" name="workplace" class="form-control is-valid"  onclick="execDaumPostcode();" placeholder="주소를 입력하시오."> 
								</div>
								...
								<div class="col-md-12 mb-12">
									<label>제목</label>
									<input type="text" class="form-control is-valid" name="title" id="validationServer02" placeholder="제목을 입력하시오" > 
								</div>
							</div>
						</div>
						
						<textarea cols="100" id="editor" rows="10" name="content"></textarea>
					</div>
					<ul class="pager">
						<li><input type="submit" class="btn btn-default" value="등록하기"></li>
						<li>
